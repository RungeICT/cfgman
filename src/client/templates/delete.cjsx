...
module.exports = React.createClass {
  ...
  onConfirmClick: () ->
    @setState {
      ...
      return logic.templates.delete(@props.template.id)
  ...
  render: () ->
    ...
    if @state.show
      ...
      popup = <Popup onClose={@onClose} title={"Delete '#{@props.template.name}'"} buttons={buttons}>
        {"Are you sure you want to delete the template '#{@props.template.name}'?"}
      </Popup>
